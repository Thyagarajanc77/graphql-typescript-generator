    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0: return [4 /*yield*/, (0, graphql_1.graphql)({
                    schema: schema, source: (0, graphql_1.getIntrospectionQuery)()
                })];
            case 1:
...
function introspectSchemaStr(schemaStr) {
    return __awaiter(this, void 0, void 0, function () {
        ...
        return __generator(this, function (_a) {
            schema = (0, graphql_1.buildASTSchema)((0, graphql_1.parse)(schemaStr));
            return [2 /*return*/, (0, exports.introspectSchema)(schema)];
        });
    });
}
function klawSync(path, filterRegex, fileNames) {
    ...
    if (fileStat.isDirectory()) {
        ...
        directory.forEach(function (f) { return klawSync((0, path_1.join)(path, f), filterRegex, fileNames); });
    }
...
var getTypeToTS = function (field, prefix, nonNullable) {
    ...
    if (field.kind === 'LIST') {
        ...
        tsType = "Array<".concat(tsType, ">");
    }
    else {
        tsType = gqlScalarToTS(field.name, prefix);
    }
    if (!nonNullable) {
        tsType = "".concat(tsType, " | null");
    }
    return tsType;
};
...
var pascalCase = function (value) {
    return (0, exports.toUppercaseFirst)(camelCase(value));
};
